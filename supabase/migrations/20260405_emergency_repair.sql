-- =========================================================
-- EMERGENCY REPAIR & RECREATION SCRIPT (2026-04-05)
-- Purpose: Forcefully recreate 'subtasks' and sync triggers
-- =========================================================
...
-- 2. CREATE SUBTASKS TABLE (FORCE REPAIR)
-- If the table is missing it will create it. If it exists but lacks columns it adds them.
...
-- 3. ENABLE RLS & POLICIES (Required for insert to work)
...
-- 4. REINSTALL SUBTASK NOTIFICATION TRIGGER
...
BEGIN
  IF NEW.assigned_user_id IS NOT NULL THEN
    ...
    VALUES (NEW.assigned_user_id, 'New Unit Assigned', 'You were assigned to: ' || NEW.title || ' in ' || t_title, 'subtask_assigned', NEW.task_id);
  END IF;
  RETURN NEW;
...
-- 5. REINSTALL PLATFORM NOTIFICATION TRIGGER
